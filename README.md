...
가계 에너지를 효율적으로 관리하는 End-to-End AI 서비스 파이프라인입니다.
...
- Mobile App: React Native(Expo) 기반 UI를 통해 사용자에게 실시간 미션 알림 및 에너지 통계 제공
...
- Storage: InfluxDB(시계열 데이터베이스)를 통한 초단위 데이터 고속 저장 및 인덱싱.
...
Capstone2026/
 ...
 ┗ ai-data-pipeline/                     # AI 코어 및 데이터 수집부
   ...
   ┃ ┗ services.py           # 핵심 비즈니스 로직 (AI 모델 추론 결과 연동 및 가공)
